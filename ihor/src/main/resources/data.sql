...
INSERT INTO PATH (startpoint_id, endpoint_id, distance) VALUES (1, 3, 550.0 );
INSERT INTO PATH (startpoint_id, endpoint_id, distance) VALUES (3, 2, 400.0 );
INSERT INTO PATH (startpoint_id, endpoint_id, distance) VALUES (4, 1, 386.0 );
INSERT INTO PATH (startpoint_id, endpoint_id, distance) VALUES (1, 4, 386.0 );
INSERT INTO PATH (startpoint_id, endpoint_id, distance) VALUES (3, 1, 550.0 );
INSERT INTO PATH (startpoint_id, endpoint_id, distance) VALUES (2, 4, 475.0 );
INSERT INTO PATH (startpoint_id, endpoint_id, distance) VALUES (2, 3, 400.0 );
...
VALUES ('2023-02-04T9:40:59.161', '2023-02-05T10:10:59.161', 200.0, 2, 32.0, 4, true, true, 1, false, '2023-02-04T9:40:59.161');

INSERT INTO RIDE (START_TIME , END_TIME , TOTAL_PRICE , DRIVER_ID , ESTIMATED_TIME , RIDE_STATUS , BABIES_ALLOWED , PETS_ALLOWED , VEHICLE_TYPE, IS_PANIC_ACTIVATED, SCHEDULED_TIME  )
VALUES ('2023-02-04T12:52:06.134', '2023-02-05T13:20:06.134', 200.0, 2, 45.0, 4, true, true, 1, false, '2023-02-04T12:52:06.134');

INSERT INTO RIDE (START_TIME , END_TIME , TOTAL_PRICE , DRIVER_ID , ESTIMATED_TIME , RIDE_STATUS , BABIES_ALLOWED , PETS_ALLOWED , VEHICLE_TYPE, IS_PANIC_ACTIVATED, SCHEDULED_TIME  )
VALUES ('2023-02-04T13:52:06.134', '2023-02-05T14:15:06.134', 300.0, 2, 27.0, 4, true, true, 1, false, '2023-02-04T13:52:06.134');

INSERT INTO RIDE (START_TIME , END_TIME , TOTAL_PRICE , DRIVER_ID , ESTIMATED_TIME , RIDE_STATUS , BABIES_ALLOWED , PETS_ALLOWED , VEHICLE_TYPE, IS_PANIC_ACTIVATED, SCHEDULED_TIME  )
VALUES ('2023-02-05T12:52:06.134', '2023-02-05T13:20:06.134', 200.0, 2, 17.0, 4, true, true, 1, false, '2023-02-05T12:52:06.134');

INSERT INTO RIDE (START_TIME , END_TIME , TOTAL_PRICE , DRIVER_ID , ESTIMATED_TIME , RIDE_STATUS , BABIES_ALLOWED , PETS_ALLOWED , VEHICLE_TYPE, IS_PANIC_ACTIVATED, SCHEDULED_TIME  )
VALUES ('2023-02-05T13:45:06.134', '2023-02-14T14:15:06.134', 300.0, 2, 20.0, 4, true, true, 1, false, '2023-02-05T13:45:06.134');

INSERT INTO RIDE (START_TIME , END_TIME , TOTAL_PRICE , DRIVER_ID , ESTIMATED_TIME , RIDE_STATUS , BABIES_ALLOWED , PETS_ALLOWED , VEHICLE_TYPE, IS_PANIC_ACTIVATED, SCHEDULED_TIME  )
VALUES ('2023-01-10T12:52:06.134', '2023-01-10T13:20:06.134', 200.0, 5, 21.0, 4, true, true, 1, false, '2023-01-10T12:52:06.134');

INSERT INTO RIDE (START_TIME , END_TIME , TOTAL_PRICE , DRIVER_ID , ESTIMATED_TIME , RIDE_STATUS , BABIES_ALLOWED , PETS_ALLOWED , VEHICLE_TYPE, IS_PANIC_ACTIVATED, SCHEDULED_TIME  )
VALUES ('2023-01-10T12:52:06.134', '2023-01-10T13:15:06.134', 300.0, 5, 24.0, 4, true, true, 1, false, '2023-01-10T12:52:06.134');
...
INSERT INTO PASSENGER_RIDE ( PASSENGER_ID , RIDE_ID ) VALUES (4,3);
INSERT INTO PASSENGER_RIDE ( PASSENGER_ID , RIDE_ID ) VALUES (1,4);
INSERT INTO PASSENGER_RIDE ( PASSENGER_ID , RIDE_ID ) VALUES (4,5);
INSERT INTO PASSENGER_RIDE ( PASSENGER_ID , RIDE_ID ) VALUES (1,5);
INSERT INTO PASSENGER_RIDE ( PASSENGER_ID , RIDE_ID ) VALUES (1,6);
INSERT INTO PASSENGER_RIDE ( PASSENGER_ID , RIDE_ID ) VALUES (4,7);

INSERT INTO RIDE_PATH ( RIDE_ID, PATH_ID) VALUES (1, 4);
INSERT INTO RIDE_PATH ( RIDE_ID, PATH_ID) VALUES (2, 3);
INSERT INTO RIDE_PATH ( RIDE_ID, PATH_ID) VALUES (3, 2);
INSERT INTO RIDE_PATH ( RIDE_ID, PATH_ID) VALUES (4, 1);
INSERT INTO RIDE_PATH ( RIDE_ID, PATH_ID) VALUES (5, 6);
INSERT INTO RIDE_PATH ( RIDE_ID, PATH_ID) VALUES (6, 7);
INSERT INTO RIDE_PATH ( RIDE_ID, PATH_ID) VALUES (7, 5);
